...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        println("Самое большое число: " + Collections.max(list) + ". Колличество символов: " + String.valueOf(Math.abs(Collections.max(list))).length() + ".");
        println("Самое маленькое число: " + Collections.min(list) + ". Колличество символов: " + String.valueOf(Math.abs(Collections.min(list))).length() + ".");
        println("");
